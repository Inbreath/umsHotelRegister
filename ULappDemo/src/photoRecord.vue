<template>
  <div class="wrapper" @back='backMethod' append="tree">
    <ums-header
      ...
      class="header">
      <text slot="right" style="color: #fff" @click="del">{{righttext}}</text>
      </ums-header>
...
<div class="new-btn-group" >
 ...
 <div class="new-btn-group" >
 <div class="console" style="height:200;">
  ...
  methods: {
    del() {
        ...
        var deposit_id = event.data;
            ...
            umsApi.executeSql(
              "delete from t_deposit where deposit_id=?",
              [deposit_id],
              ret => {
                ...
                umsApi.closeDB(ret => {
                  ...
                  if (data.type == "success") {             
                      umsApi.navigator.push({url: 'deleteSuccess.js'})
                    }else{
